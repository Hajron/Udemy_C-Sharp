...
namespace HelloWorld // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] myGrocertArray = new string[2];

            myGrocertArray[0] = "Guacamole";
            myGrocertArray[1] = "Ice Cream";
            
            Console.WriteLine(myGrocertArray[0]);
            Console.WriteLine(myGrocertArray[1]);
            // Console.WriteLine(myGrocertArray[2]);
